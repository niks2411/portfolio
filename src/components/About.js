...
const About = () => {
  ...
  return (
    <section id="about" className={`section-padding relative overflow-hidden transition-colors duration-300 ${
      isDarkMode ? 'bg-slate-900' : 'bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50'
    }`}>
      {/* Background Elements */}
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          >
            ...
            <div className="text-center lg:text-left">
              <p className={`text-base sm:text-lg leading-relaxed mb-4 transition-colors duration-300 ${
          ...
          >
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                className={`group relative overflow-hidden rounded-xl backdrop-blur-sm transition-all duration-300 hover:shadow-xl ${
                  isDarkMode 
                    ? 'bg-slate-800/50 border border-slate-700/50 hover:border-slate-600/50 hover:shadow-purple-500/10' 
                    : 'bg-white/80 border border-gray-200 hover:border-purple-300 hover:shadow-purple-500/30'
                }`}
              >
              ...
              {stats.map((stat, index) => (
                ...
                >
                  <div className={`rounded-xl p-4 border transition-all duration-300 hover:shadow-lg ${
                    isDarkMode 
                      ? 'bg-slate-800/50 border-slate-700/50 hover:border-purple-500/50 hover:shadow-purple-500/10'
                      : 'bg-white/80 border-gray-200 hover:border-purple-300 hover:shadow-purple-500/30'
                  }`}>
                    ...
                    <div className={`mt-2 opacity-60 group-hover:opacity-100 transition-opacity duration-300 ${
