...
const Resume = () => {
  ...
  return (
    <section id="resume" className={`section-padding relative overflow-hidden transition-colors duration-300 ${
      isDarkMode ? 'bg-slate-800' : 'bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50'
    }`}>
      {/* Background Elements */}
              ...
              <div className="p-6">
                {resumeSections.map((section, sectionIndex) => (
                  <div key={sectionIndex} className="mb-8">
                    <h4 className={`text-xl font-bold mb-4 flex items-center transition-colors duration-300 ${
          ...
          >
            ...
            <div className="bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl p-6 text-white">
              ...
              <motion.button
                ...
                className="w-full bg-white text-purple-600 px-4 py-2 rounded-lg font-semibold hover:bg-slate-100 transition-colors duration-300"
              >
                Contact Me
              </motion.button>
            </div>
